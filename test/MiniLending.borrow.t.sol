...
contract MiniLendingBorrowTest is MiniLendingTestBase {
    ...
    function test_borrowUpdatesDebtHealthAndBalances() public {
        ...
        emit Borrowed(alice, 2_000e6);
        lending.borrow(2_000e6);
    ...
    function test_borrowAgainstIsolatedWbtcDebtCeiling() public {
    ...
    function test_revertBorrowInvalidOrAboveLimit() public {
        vm.prank(alice);
    ...
    function test_multipleBorrowsRespectCollateralLimit() public {
        _depositWeth(alice, 1 ether);
